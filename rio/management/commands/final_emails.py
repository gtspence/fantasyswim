...
class Command(BaseCommand):
	help = 'Sends email to all users with their final result'
	...
	def handle(self, *arg, **options):
		...
		for team in teams:
			...
			text = "Final result: Your team %s scored %s and %s." % (team.name, points, golds)
			...
			subject='Fantasy Swimming Rio: Final Scores!'
			body = loader.render_to_string('rio/final.html', {'text':text, 'user':team.user})
